...
//float duration1, distance1, duration2, distance2, duration3, distance3, duration4, distance 4;
...
void loop() {  
  ...
  //if (distanceVolume <= 10.5){
  //  volume = 31.75;
 // }else if (distanceVolume <= 16){
  //  volume = 63.5;
  //}else if (distanceVolume <= 21.5){
 //   volume = 95.25;
 // }else{
  //  volume = 127;
  //};
